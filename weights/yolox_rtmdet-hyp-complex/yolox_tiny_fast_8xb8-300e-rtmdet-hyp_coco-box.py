...
log_level = 'INFO'
load_from = 'https://download.openmmlab.com/mmyolo/v0/yolox/yolox_tiny_fast_8xb32-300e-rtmdet-hyp_coco/yolox_tiny_fast_8xb32-300e-rtmdet-hyp_coco_20230210_143637-4c338102.pth'
resume = False
...
val_evaluator = dict(
    ...
    ann_file='./data/box_coco/val.json',
    metric='bbox')
test_evaluator = dict(
    type='mmdet.CocoMetric',
    proposal_nums=(100, 1, 10),
...
image_scale = (416, 416)
launcher = 'pytorch'
work_dir = './work_dirs/yolox_rtmdet-hyp-complex'
